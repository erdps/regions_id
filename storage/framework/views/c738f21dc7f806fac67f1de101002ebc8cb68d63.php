        ...
        <div class="container">
            ...
            <div class="row">
                <div class="offset-4 col-4 text-center m-auto subscribe-section pt-5">
                    ...
                    <form action="<?php echo e(route('store')); ?>" method="POST" enctype="multipart/form-data" id="subscribe_form">
...
</html><?php /**PATH C:\xampp\htdocs\designcub3\resources\views/tugasdua/subscribe.blade.php ENDPATH**/ ?>